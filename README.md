# INT using P4 
We have a linear topology with 8 switches as shown in ![INT p4Runtime Topolgy](./images/topology.jpg). Out of these 8 switches 4 are bottleneck switches as they are rate limited. All the switches are P4's bmv2 model backend target simple_switch_grpc which talks over p4Runtime API to remote python based custom Controller.   
